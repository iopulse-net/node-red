 ...
 */
const sendFlowDetails = async (data) => {
    try {
        const config = {
            headers: {
        ...
        const res = await axios.post('http://localhost:8080/flow', data, config);
...
errorFlowDetails = (timestamp, msg, data) => {
    req_data = {
        flow_id: data.z,
        type: "error",
        timestamp: timestamp,
...
Node.prototype.error = function(logMessage,msg) {
    timestamp = new Date().getTime();
    errorFlowDetails(timestamp, logMessage, this);
