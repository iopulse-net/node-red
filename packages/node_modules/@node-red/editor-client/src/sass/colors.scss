...
$deploy-button-color-disabled: #fff;
$deploy-button-background: #8C101C;
$deploy-button-background-hover: #6E0A1E;
$deploy-button-background-active: #4C0A17;
$deploy-button-background-disabled: #99CCFF;
$deploy-button-background-disabled-hover: #99CCEE;


$header-background: #114b8d;
$header-button-background-active: #114b8d;
$header-menu-color: #fff;
$header-menu-color-hover: #F8F8FF;
